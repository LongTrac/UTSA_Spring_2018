...
public class CommercialFlight extends Flight {
	/**
	 * constructor of the CommercialFlight class that call the super class
	 ...
	 */
	public CommercialFlight(int flightNum, String origin, String destination, String departure, String arrival) {
